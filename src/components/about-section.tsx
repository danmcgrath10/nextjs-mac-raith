    ...
    <section id="about" className="py-16 sm:py-24 lg:py-32 bg-muted/30 relative">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          >
            ...
            <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-muted-foreground">
              Passion and precision define my approach to audio engineering. I&apos;m Mac Raith, 
              dedicated to delivering exceptional sound through innovative techniques and meticulous 
              attention to detail.
            </p>
          </motion.div>
        </div>
        ...
        <div className="mx-auto mt-12 sm:mt-16 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-12 sm:gap-y-16 lg:mx-0 lg:mt-10 lg:max-w-none lg:grid-cols-12 lg:gap-x-8">
          ...
          >
            <p>
              My passion stems from a desire to create immersive worlds for listeners to inhabit 
              through music. Over the past two years, I&apos;ve fully immersed myself in the craft, 
              mastering modern tools and techniques, and developing a sharp ear for what makes 
              music truly stand out.
            </p>
            <p className="mt-6 sm:mt-8">
              Though newer to the field, I bring a fresh perspective, boundless enthusiasm, and a 
              relentless commitment to staying at the forefront of industry trends. Every project 
              I undertake is met with professionalism, dedication, and an unwavering ambition to 
              exceed expectations, ensuring your music achieves the polished, professional sound it 
              deserves.
            </p>
